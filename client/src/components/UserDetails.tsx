...
const UserDetails = ({ name, time, setTime, color, currentTurn,onResign,offerDraw ,myTurn}: UserDetailsProps) => {
    return (
        ...
        <div className="flex flex-row items-center justify-between gap-x-5 w-full bg-zinc-700 text-white p-2">
            <div className="flex items-center gap-x-5">
                ...
                <Timer time={time} setTime={setTime} color={color} currentTurn={currentTurn} myTurn ={myTurn}/>
            </div>
            <div>
                {
                    offerDraw &&
